...
def main():
    ...
    # not enough, just foot sliding, no pose change
    ...
    # minimal but effective, 3 features
    selected_feature_names = ['lFootPos', 'rFootPos', 'trajectoryPos2D']
    selected_feature_weights = [1.0, 1.0, 0.8]

    # balanced approach, 5 features
    # selected_feature_names = ['lFootPos', 'rFootPos', 'hipVel', 'trajectoryPos2D', 'trajectoryRot2D']
    # selected_feature_weights = [1.0, 1.0, 0.6, 0.7, 0.5]

    # full body awareness -> too many features, too bad results
    # selected_feature_names = ['lFootPos', 'rFootPos', 'lHandPos', 'rHandPos', 'hipVel', 'trajectoryPos2D', 'trajectoryRot2D']
    # selected_feature_weights = [1.0, 1.0, 0.5, 0.5, 0.6, 0.7, 0.7]
